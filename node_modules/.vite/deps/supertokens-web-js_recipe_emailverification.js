...
} from "./chunk-DRFDU7BR.js";
import {
  require_querier,
  require_utils as require_utils2
} from "./chunk-E7JKWEAK.js";
import {
  require_session
} from "./chunk-NOACAIDW.js";
import {
  require_build,
  require_sessionClaimValidatorStore
} from "./chunk-LLX5MEQU.js";
import {
  require_utils
} from "./chunk-P7PG7344.js";
import {
  __commonJS
  ...
  "node_modules/supertokens-web-js/lib/build/recipe/emailverification/emailVerificationClaim.js"(exports) {
    ...
    var EmailVerificationClaimClass = (
      ...
      function(_super) {
        ...
        function EmailVerificationClaimClass2(getRecipeImpl, updateContextOnIsVerifiedFalse) {
            ...
            isVerified: function(refetchTimeOnFalseInSeconds, maxAgeInSeconds) {
              ...
              return {
                ...
                shouldRefresh: function(payload, userContext) {
                  ...
                  return value === void 0 || _this.getLastFetchedTime(payload, userContext) < Date.now() - maxAgeInSeconds * 1e3 || value === false && _this.getLastFetchedTime(payload, userContext) < Date.now() - refetchTimeOnFalseInSeconds * 1e3;
                },
                    ...
                    return __generator(this, function(_a) {
                      switch (_a.label) {
                        case 0:
                          ...
                          if (!(value !== true && updateContextOnIsVerifiedFalse !== void 0))
                            return [3, 2];
                          return [4, updateContextOnIsVerifiedFalse(userContext)];
                        case 1:
                          _a.sent();
                          _a.label = 2;
                        case 2:
        ...
        Recipe2.init = function(config) {
          return function(appInfo) {
            Recipe2.instance = new Recipe2(
              __assign(__assign({}, config), { appInfo, recipeId: Recipe2.RECIPE_ID })
            );
...
var require_emailverification = __commonJS({
  "node_modules/supertokens-web-js/lib/build/recipe/emailverification/index.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EmailVerificationClaimClass = exports.EmailVerificationClaim = exports.getEmailVerificationTokenFromURL = exports.isEmailVerified = exports.sendVerificationEmail = exports.verifyEmail = exports.init = void 0;
