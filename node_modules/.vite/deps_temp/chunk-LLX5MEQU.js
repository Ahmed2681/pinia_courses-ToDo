  ...
  "node_modules/supertokens-website/lib/build/utils/lockFactory/index.js"(exports) {
    ...
    var LockFactoryReference = (
      ...
      function() {
        ...
        LockFactoryReference2.init = function(lockFactory) {
            ...
            return __generator(_a, function(_b) {
              switch (_b.label) {
                case 0:
                  ...
                  try {
                    doNotDoInterception = typeof url === "string" && !(0, utils_1.shouldDoInterceptionBasedOnUrl)(
                      url,
                      AuthHttpRequest2.config.apiDomain,
                      AuthHttpRequest2.config.sessionTokenBackendDomain
                    ) || url !== void 0 && typeof url.url === "string" && // this is because url can be an object like {method: ..., url: ...}
                ...
                case 3:
                  accessToken = _b.sent();
                  if (accessToken !== void 0 && origHeaders.get("Authorization") === "Bearer ".concat(accessToken)) {
                    (0, logger_1.logDebugMessage)(
        ...
        self.open = function(_, u) {
          ...
          try {
            doNotDoInterception = typeof url === "string" && !(0, utils_1.shouldDoInterceptionBasedOnUrl)(
              ...
              fetch_1.default.config.apiDomain,
              fetch_1.default.config.sessionTokenBackendDomain
            ) || typeof url !== "string" && !(0, utils_1.shouldDoInterceptionBasedOnUrl)(
              url.toString(),
              fetch_1.default.config.apiDomain,
              fetch_1.default.config.sessionTokenBackendDomain
            );
...
var require_types = __commonJS({
  "node_modules/supertokens-website/lib/build/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SessionClaimValidator = void 0;
    var SessionClaimValidator = (
      /** @class */
      function() {
        function SessionClaimValidator2(id) {
          this.id = id;
        }
        return SessionClaimValidator2;
      }()
    );
...
//# sourceMappingURL=chunk-LLX5MEQU.js.map
